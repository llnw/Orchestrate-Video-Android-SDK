Feature: Configuring the Settings
    Scenario: Check settings page has default values for Organisation Id, Access Key,Secret key,URL,License Proxy, Portal Key when it is launched.
        ...
        Then value of Organization ID in SETTINGS tab should be 17fbbde5ce1e43e087bcbfffbf0680ca
         And value of Access Key in CURRENT tab should be sB8TWEftj8ZhYXol7pVWFuutJ4M=
         And value of Secret Key in CURRENT tab should be lR46aeyMmlgTOod17Kl9XqNgaYE=
