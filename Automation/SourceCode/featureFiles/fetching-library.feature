Feature: Fetching Library 
    ...
    Given the application has launched with following configuration in SETTINGS tab -
     ...
     When I attempt-to-play the "Now You See Me" video from ALL MEDIA with "no-select" encoding
     Then the POPUP should have following valid available encoding -
     | valid available encoding              |
     | HttpLiveStreaming 96 X200kbps 224X534 |
     | Flash 128 X472kbps 268X640            |
     | Flash 96 X128kbps 268X640             |
     | MobileH264 128 X322kbps 268X640       |
     | Mobile3gp 64 X128kbps 144X342         |
     | Flash 128 X322kbps 268X640            |
