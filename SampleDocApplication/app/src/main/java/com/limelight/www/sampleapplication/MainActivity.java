...
import com.limelight.www.sampleapplication.MediaOfChannel.MediaOfChannelCallback;
...
public class MainActivity extends FragmentActivity implements IPlayerCallback, OnPageChangeListener,ActionBar.TabListener {
    private String mChannelID = "9172738df39349869f8ebeb71b51ef1c";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* configuring SDK
        Setting.configureLimelightSettings(Constants.API_PROD, Constants.LICENSE_PROD, "limelight");
        LoggerUtil.setLogLevelByString("Debug",this);
        Setting.SetAnalyticsEndPoint(Constants.ANALYTICS_PROD);
        */
        ...
        actionBar.addTab(actionBar.newTab().setText(mSectionsPagerAdapter.getPageTitle(0)).setTabListener(this));        actionBar.addTab(actionBar.newTab().setText(mSectionsPagerAdapter.getPageTitle(1)).setTabListener(this));
    }
