...
public class PreferenceManagerCompat {
    private static final String TAG = PreferenceManagerCompat.class
            .getSimpleName();
    ...
    interface OnPreferenceTreeClickListener {
         ...
         *            The {@link PreferenceScreen} that the preference is
         *            located in.
         * @param preference
    ...
    static PreferenceManager newInstance(Activity activity, int firstRequestCode) {
        try {
            ...
            Log.w(TAG,
                    "Couldn't call constructor PreferenceManager by reflection",
                    e);
        }
        return null;
    }
     ...
     */
    static void setFragment(PreferenceManager manager,
    ...
    static void setOnPreferenceTreeClickListener(PreferenceManager manager,
        ...
        try {
            ...
            if (listener != null) {
                Object proxy = Proxy
                        .newProxyInstance(onPreferenceTreeClickListener
                                .getType().getClassLoader(),
                                new Class[] { onPreferenceTreeClickListener
                                        .getType() }, new InvocationHandler() {
                                    public Object invoke(Object proxy,
                                            Method method, Object[] args) {
                                        if (method.getName().equals(
                                                "onPreferenceTreeClick")) {
                                            return Boolean.valueOf(listener
                                                    .onPreferenceTreeClick(
            ...
            Log.w(TAG,
                    "Couldn't set PreferenceManager.mOnPreferenceTreeClickListener by reflection",
                    e);
        }
    }
     ...
     *         root).
     */
    static PreferenceScreen inflateFromIntent(PreferenceManager manager,
            Intent intent, PreferenceScreen screen) {
        try {
            Method m = PreferenceManager.class.getDeclaredMethod(
                    "inflateFromIntent", Intent.class, PreferenceScreen.class);
            m.setAccessible(true);
            PreferenceScreen prefScreen = (PreferenceScreen) m.invoke(manager,
                    intent, screen);
            return prefScreen;
        } catch (Exception e) {
            Log.w(TAG,
                    "Couldn't call PreferenceManager.inflateFromIntent by reflection",
                    e);
        }
        return null;
    }
    ...
    static PreferenceScreen inflateFromResource(PreferenceManager manager,
        ...
        try {
            ...
            m.setAccessible(true);
            PreferenceScreen prefScreen = (PreferenceScreen) m.invoke(manager,
                    activity, resId, screen);
            return prefScreen;
        } catch (Exception e) {
            Log.w(TAG,
                    "Couldn't call PreferenceManager.inflateFromResource by reflection",
                    e);
        }
        return null;
    }
    ...
    static PreferenceScreen getPreferenceScreen(PreferenceManager manager) {
        try {
            ...
            Log.w(TAG,
                    "Couldn't call PreferenceManager.getPreferenceScreen by reflection",
                    e);
        }
        return null;
    }
     ...
     */
    static void dispatchActivityResult(PreferenceManager manager,
        ...
        try {
            ...
            Log.w(TAG,
                    "Couldn't call PreferenceManager.dispatchActivityResult by reflection",
                    e);
        }
    }
    ...
    static void dispatchActivityStop(PreferenceManager manager) {
        try {
            ...
            Log.w(TAG,
                    "Couldn't call PreferenceManager.dispatchActivityStop by reflection",
                    e);
        }
    }
    ...
    static void dispatchActivityDestroy(PreferenceManager manager) {
        try {
            ...
            Log.w(TAG,
                    "Couldn't call PreferenceManager.dispatchActivityDestroy by reflection",
                    e);
        }
    }
     ...
     *         previous.
     */
    static boolean setPreferences(PreferenceManager manager,
        ...
        try {
            ...
            Log.w(TAG,
                    "Couldn't call PreferenceManager.setPreferences by reflection",
                    e);
        }
        return false;
    }
